...
namespace Public
{
	...
	public partial class AspnetRole : ActiveRecord<AspnetRole>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Roles", TableType.Table, DataService.GetInstance("ViewWeb"));
				...
				DataService.Providers["ViewWeb"].AddSchema("aspnet_Roles",schema);
			}
		}
		#endregion
		...
		{
			return new Public.AspnetUsersInRoleCollection().Where(AspnetUsersInRole.Columns.RoleId, RoleId).Load();
		}
		#endregion
		...
		public Public.AspnetUserCollection GetAspnetUserCollection() { return AspnetRole.GetAspnetUserCollection(this.RoleId); }
		public static Public.AspnetUserCollection GetAspnetUserCollection(Guid varRoleId)
		{
