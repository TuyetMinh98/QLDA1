...
namespace Public{
    ...
    public partial class VwAspnetApplication : ReadOnlyRecord<VwAspnetApplication>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_Applications", TableType.View, DataService.GetInstance("ViewWeb"));
                ...
                DataService.Providers["ViewWeb"].AddSchema("vw_aspnet_Applications",schema);
            }
        }
        #endregion
