...
namespace Public
{
	...
	public partial class AspnetWebEventEvent : ActiveRecord<AspnetWebEventEvent>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_WebEvent_Events", TableType.Table, DataService.GetInstance("ViewWeb"));
				...
				DataService.Providers["ViewWeb"].AddSchema("aspnet_WebEvent_Events",schema);
			}
		}
		#endregion
