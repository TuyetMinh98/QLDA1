...
namespace Public
{
	...
	public partial class AspnetSchemaVersion : ActiveRecord<AspnetSchemaVersion>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_SchemaVersions", TableType.Table, DataService.GetInstance("ViewWeb"));
				...
				DataService.Providers["ViewWeb"].AddSchema("aspnet_SchemaVersions",schema);
			}
		}
		#endregion
