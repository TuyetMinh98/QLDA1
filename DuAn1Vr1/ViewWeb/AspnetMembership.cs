...
namespace Public
{
	...
	public partial class AspnetMembership : ActiveRecord<AspnetMembership>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Membership", TableType.Table, DataService.GetInstance("ViewWeb"));
				...
				DataService.Providers["ViewWeb"].AddSchema("aspnet_Membership",schema);
			}
		}
		#endregion
