...
namespace Public{
    ...
    public partial class VwAspnetProfile : ReadOnlyRecord<VwAspnetProfile>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_Profiles", TableType.View, DataService.GetInstance("ViewWeb"));
                ...
                DataService.Providers["ViewWeb"].AddSchema("vw_aspnet_Profiles",schema);
            }
        }
        #endregion
