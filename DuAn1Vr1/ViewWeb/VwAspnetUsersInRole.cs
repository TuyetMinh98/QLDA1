...
namespace Public{
    ...
    public partial class VwAspnetUsersInRole : ReadOnlyRecord<VwAspnetUsersInRole>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_UsersInRoles", TableType.View, DataService.GetInstance("ViewWeb"));
                ...
                DataService.Providers["ViewWeb"].AddSchema("vw_aspnet_UsersInRoles",schema);
            }
        }
        #endregion
