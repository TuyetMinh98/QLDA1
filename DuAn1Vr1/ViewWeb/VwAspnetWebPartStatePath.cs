...
namespace Public{
    ...
    public partial class VwAspnetWebPartStatePath : ReadOnlyRecord<VwAspnetWebPartStatePath>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_WebPartState_Paths", TableType.View, DataService.GetInstance("ViewWeb"));
                ...
                DataService.Providers["ViewWeb"].AddSchema("vw_aspnet_WebPartState_Paths",schema);
            }
        }
        #endregion
