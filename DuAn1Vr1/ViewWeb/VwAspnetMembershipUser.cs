...
namespace Public{
    ...
    public partial class VwAspnetMembershipUser : ReadOnlyRecord<VwAspnetMembershipUser>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_MembershipUsers", TableType.View, DataService.GetInstance("ViewWeb"));
                ...
                DataService.Providers["ViewWeb"].AddSchema("vw_aspnet_MembershipUsers",schema);
            }
        }
        #endregion
