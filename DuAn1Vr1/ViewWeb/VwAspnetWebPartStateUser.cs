...
namespace Public{
    ...
    public partial class VwAspnetWebPartStateUser : ReadOnlyRecord<VwAspnetWebPartStateUser>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_WebPartState_User", TableType.View, DataService.GetInstance("ViewWeb"));
                ...
                DataService.Providers["ViewWeb"].AddSchema("vw_aspnet_WebPartState_User",schema);
            }
        }
        #endregion
