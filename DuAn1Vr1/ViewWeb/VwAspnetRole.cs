...
namespace Public{
    ...
    public partial class VwAspnetRole : ReadOnlyRecord<VwAspnetRole>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_Roles", TableType.View, DataService.GetInstance("ViewWeb"));
                ...
                DataService.Providers["ViewWeb"].AddSchema("vw_aspnet_Roles",schema);
            }
        }
        #endregion
