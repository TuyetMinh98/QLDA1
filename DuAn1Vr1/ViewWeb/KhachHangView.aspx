<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="KhachHangView.aspx.cs" Inherits="ViewWeb.KhachHangView" %>
        ...
        <asp:GridView AutoGenerateColumns="False" ID="nv" runat="server" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1.2px" CellPadding="4">
            <Columns>
                <asp:TemplateField HeaderText="Họ Tên Khách Hàng">
                    <ItemTemplate>
                        <asp:Label ID="lblName1" runat="server" Text='<%# Eval("HoTen") %>'></asp:Label>
                    </ItemTemplate>
