...
namespace Public
{
	...
	public partial class AspnetPath : ActiveRecord<AspnetPath>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Paths", TableType.Table, DataService.GetInstance("ViewWeb"));
				...
				DataService.Providers["ViewWeb"].AddSchema("aspnet_Paths",schema);
			}
		}
		#endregion
		...
		public Public.AspnetPersonalizationAllUserCollection AspnetPersonalizationAllUsers()
		{
			return new Public.AspnetPersonalizationAllUserCollection().Where(AspnetPersonalizationAllUser.Columns.PathId, PathId).Load();
		}
		public Public.AspnetPersonalizationPerUserCollection AspnetPersonalizationPerUserRecords()
		{
			return new Public.AspnetPersonalizationPerUserCollection().Where(AspnetPersonalizationPerUser.Columns.PathId, PathId).Load();
		}
		#endregion
