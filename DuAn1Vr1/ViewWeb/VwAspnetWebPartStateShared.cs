...
namespace Public{
    ...
    public partial class VwAspnetWebPartStateShared : ReadOnlyRecord<VwAspnetWebPartStateShared>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_WebPartState_Shared", TableType.View, DataService.GetInstance("ViewWeb"));
                ...
                DataService.Providers["ViewWeb"].AddSchema("vw_aspnet_WebPartState_Shared",schema);
            }
        }
        #endregion
