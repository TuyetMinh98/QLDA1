...
namespace Public
{
	...
	public partial class AspnetProfile : ActiveRecord<AspnetProfile>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Profile", TableType.Table, DataService.GetInstance("ViewWeb"));
				...
				DataService.Providers["ViewWeb"].AddSchema("aspnet_Profile",schema);
			}
		}
		#endregion
