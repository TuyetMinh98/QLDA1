...
namespace Public
{
	...
	public partial class AspnetUser : ActiveRecord<AspnetUser>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Users", TableType.Table, DataService.GetInstance("ViewWeb"));
				...
				DataService.Providers["ViewWeb"].AddSchema("aspnet_Users",schema);
			}
		}
		#endregion
		...
		public Public.AspnetMembershipCollection AspnetMembershipRecords()
		{
			return new Public.AspnetMembershipCollection().Where(AspnetMembership.Columns.UserId, UserId).Load();
		}
		public Public.AspnetPersonalizationPerUserCollection AspnetPersonalizationPerUserRecords()
		{
			return new Public.AspnetPersonalizationPerUserCollection().Where(AspnetPersonalizationPerUser.Columns.UserId, UserId).Load();
		}
		public Public.AspnetProfileCollection AspnetProfileRecords()
		{
			return new Public.AspnetProfileCollection().Where(AspnetProfile.Columns.UserId, UserId).Load();
		}
		public Public.AspnetUsersInRoleCollection AspnetUsersInRoles()
		{
			return new Public.AspnetUsersInRoleCollection().Where(AspnetUsersInRole.Columns.UserId, UserId).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public Public.AspnetApplication AspnetApplication
		{
			get { return Public.AspnetApplication.FetchByID(this.ApplicationId); }
		...
		public Public.AspnetRoleCollection GetAspnetRoleCollection() { return AspnetUser.GetAspnetRoleCollection(this.UserId); }
