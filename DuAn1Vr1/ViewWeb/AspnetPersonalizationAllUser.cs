...
namespace Public
{
	...
	public partial class AspnetPersonalizationAllUser : ActiveRecord<AspnetPersonalizationAllUser>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_PersonalizationAllUsers", TableType.Table, DataService.GetInstance("ViewWeb"));
				...
				DataService.Providers["ViewWeb"].AddSchema("aspnet_PersonalizationAllUsers",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public Public.AspnetPath AspnetPath
		{
			get { return Public.AspnetPath.FetchByID(this.PathId); }
